...
export const MOCK_OPINIONS: Opinion[] = [
  ...
  { id: "o-3", proposal_id: "p-1", user_id: "u-alex", stance: "CONDITIONAL_AGREE", comment: "완전히 반대는 아닌데, 기존 신규 입사자 설문에서 영상 선호가 높았던 게 걸려요.", created_at: hoursAgo(20) },
  ...
  { id: "o-8", proposal_id: "p-2", user_id: "u-haruto", stance: "CONDITIONAL_AGREE", comment: "월요일만 화상으로 유지하면 좋겠어요.", created_at: hoursAgo(6) },
  ...
  { id: "o-10", proposal_id: "p-3", user_id: "u-mina", stance: "CONDITIONAL_AGREE", comment: "긴급 리뷰를 별도로 표시하는 조건이라면 48시간 기준에 동의해요.", created_at: hoursAgo(49) },
  ...
  { id: "o-14", proposal_id: "p-3", user_id: "u-omar", stance: "CONDITIONAL_AGREE", comment: "명확한 우선순위 규칙을 함께 적용하는 조건으로 동의합니다.", created_at: hoursAgo(38) },
...
// 주의: 이미 응답(Opinions에 레코드 있음)한 사용자에게는 OPINION_REQUESTED 알림을 만들지 않음.
export const MOCK_NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    ...
    user_id: "u-jiwoo",
    proposal_id: "p-3",
    type: "CONSENSUS_SUMMARY_COMPLETED",
